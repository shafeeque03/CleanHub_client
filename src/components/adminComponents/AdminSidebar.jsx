        ...
        <>
            <div className="drawer flex justify-end  md:hidden z-10 bg-white">
                ...
                <div className="drawer-side">
                    ...
                    ></label>
                    <div className="p-4 w-80 min-h-full bg-gray-50 text-base-content">
                                    ...
                                    <Link
                                        ...
                                        className={
                                            location.pathname === "/admin/dashboard"
                                                ? "flex items-center p-2 text-gray-800 rounded-lg dark:text-gray hover:bg-gray-100 dark:hover:bg-gray-700 group"
                                                : "flex items-center p-2 text-gray-900 rounded-lg dark:text-gray hover:bg-gray-100 dark:hover:bg-gray-700 group"
                                        }
                                    >
                                        <svg
                                            fill="none"
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <Link
                                to="/admin/pickups"
                                className={
                                    location.pathname === "/admin/pickups"
                                        ? "flex items-center p-2 text-gray-800 rounded-lg dark:text-grayhover:bg-gray-100 dark:hover:bg-gray-200 group"
                                        : "flex items-center p-2 text-gray-500 rounded-lg dark:text-grayhover:bg-gray-100 dark:hover:bg-gray-200 group"
                                }
                            >
