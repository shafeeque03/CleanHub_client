      ...
      {loading ? (
        ...
        <div className="p-3 w-full bg-white flex-wrap justify-center gap-7 flex">
          {giftcards.length < 1 ? (
            ...
            giftcards.map((card) => (
              <div className="w-1/4 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-green-800 ">
                <svg
                ...
                <a href="#">
                  <h5 class="mb-2 text-2xl font-semibold tracking-tight text-yellow-600">
                    {card.name}
                  </h5>
                </a>
