        ...
        <div class="login-box">
          ...
          <form onSubmit={handleSubmit}>
            <div class="input-box">
              ...
              <label for="user" class="label text-slate-700">
                Email
              </label>
              <i class="bx bx-user icon text-slate-700"></i>
            ...
            <div class="input-box">
              <input
                ...
                onBlur={handleBlur}
              />
              <label for="pass" class="label text-slate-700">
                Password
              </label>
              <i class="bx bx-lock-alt icon text-slate-800" id="show-password"></i>
            </div>
            <div class="remember-forgot">
              <div class="forgot text-slate-700">
              <Link to="/forgotPassword">Forgot Password</Link>
              </div>
            </div>

            <div class="input-box">
              <input type="submit" class="input-submit text-slate-700" value="Login" />
            </div>
            <div class="register">
